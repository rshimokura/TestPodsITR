#
#  Be sure to run `pod spec lint TestPodsITR.podspec' to ensure this is a
...
This is for test. You'll get nothing though you can use.
  ...
  spec.homepage     = "https://github.com/rshimokura/TestPodsITR"
  ...
  # Or just: spec.author    = "rshimokura"
  # spec.authors            = { "rshimokura" => "rshimokura@itrealize.co.jp" }
  # spec.social_media_url   = "https://twitter.com/rshimokura"
  ...
  spec.source_files  = [ "Classes/**/*.swift", "TestPodsITR/TestPodsITR.h" ]
#, "TestPodsITR/LibITR.xcframework/Headers/*.h" ]
